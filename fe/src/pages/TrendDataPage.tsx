...
import { useTrendDataSearch } from '@/api/trendData';
...
export function TrendDataPage() {
  ...
  const params: TrendDataSearchParams = {
    page: table.page,
    size: table.pageSize,
  ...
  const { data, isFetching } = useTrendDataSearch(params);
  ...
  return (
    <Box>
      <PageHeader
        title="Trend Data"
        subtitle="Historical sensor readings (read-only, filterable)"
      />
